...
router.get(
  "/teachers/:id/overallRating",
  teacherController.getTeacherOverallRating
);
...
router.get(
  "/announcementReviews/:id",
  announcementReviewController.getReviewsByAnnouncement
);
