...
//       const [teacherResponse, announcementsResponse, reviewsResponse] =
//         await Promise.all([
...
//     try {
//       // Prepare payload with EXACT database field names
//       const payload = {
...
//     <h4>{newReview.id ? "Edit Review" : "Add New Review"}</h4>
...
//           {newReview.id ? "Update" : "Submit"} Review
//         </button>
//         <button 
//           type="button" 
...
//                         – {review.student_firstname || "Student"}{" "}
//                         {review.student_lastname || ""}
//                       </p>
//                     </div>
//                   ))}
//                 </div>
...
//                     expandedAnnouncement === announcement.id ? "expanded" : ""
//                   }`}
//                 >
