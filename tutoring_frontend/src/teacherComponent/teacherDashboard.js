...
const TeacherDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5001/api/teachers/${teacherId}`)
    ...
    axios
      .get(`http://localhost:5001/api/teacher/${teacherId}`)
  ...
  const fetchReviews = async (announcementId) => {
    ...
    try {
      const response = await axios.get(`http://localhost:5001/api/announcementReviews/${announcementId}`)
  ...
  const handleCreateAnnouncement = (e) => {
    ...
    axios
      .post(
        "http://localhost:5001/api/create_announcements",
        {
  ...
  const handleUpdateAnnouncement = (e) => {
    ...
    axios
      .put(
        `http://localhost:5001/api/update_announcements/${updateAnnouncement.id}`,
        {
  ...
  const handleDeleteAnnouncement = (id) => {
    ...
    axios
      .delete(`http://localhost:5001/api/delete_announcements/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
